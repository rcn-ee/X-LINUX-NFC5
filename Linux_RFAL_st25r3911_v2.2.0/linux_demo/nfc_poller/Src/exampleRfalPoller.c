...
const char* LOG_HEADER = "Welcome to the ST25R3911 NFC Poller Demo on Linux.\nScanning for NFC technologies ";
        ...
        case EXAMPLE_RFAL_POLLER_TYPE_NFCA:
            ...
            switch( gDevList[devIt].dev.nfca.type )
            {
                ...
                case RFAL_NFCA_T4T:
                    ...
                    rfalIsoDepInitialize(); /*svs: This function call was not there in the previous application file */
